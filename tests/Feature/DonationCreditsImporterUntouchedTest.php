...
it('Donations importer source files contain no DonationCredit references', function () {
    $sources = [
        base_path('vendor/nonprofitcrm/donations/Filament/Pages/ImportDonationsPage.php'),
        base_path('vendor/nonprofitcrm/donations/Filament/Pages/ImportDonationsProgressPage.php'),
        base_path('vendor/nonprofitcrm/donations/Importers/DonationFieldRegistry.php'),
    ];
